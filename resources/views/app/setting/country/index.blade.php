...
<section id="basic-datatable">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <table class="datatables-basic table" id="country_table">
          <thead>
            <tr>
              <th>Id</th>
              <th>Name</th>
...
@section('page-script')
  ...
  <script type="text/javascript">
    ...
    var table_id = 'country_table'
    var table_title = 'Countries List';
    var table_route = {
          url: '{{ route('settings.country.index') }}',
          data: function (data) {
                // data.role = $("#role").val();
            }
        };
      ...
      var buttons = [
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    window.location.href = '{{ route("settings.country.create") }}';
                }
            },
        ];
