...
<section id="basic-datatable">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <table class="datatables-basic table" id="proficiency_table">
          <thead>
            <tr>
              <th>Id</th>
              <th>Name</th>
...
@section('page-script')
  ...
  <script type="text/javascript">
    ...
    var table_id = 'proficiency_table'
    var table_title = 'Proficiency List';
    var table_route = {
          url: '{{ route('proficiency.index') }}',
          data: function (data) {
                // data.role = $("#role").val();
            }
        };
      ...
      var buttons = [
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    window.location.href = '{{ route("proficiency.create") }}';
                }
            },
        ];
