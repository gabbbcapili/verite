...
class Setting extends Model
{
    ...
    protected $fillable = ['email_footer','spaf_completed','spaf_reminder','spaf_create',
                            ...
                            'admin_change_role_of','welcome_client','welcome_supplier', 'schedule_cf_1','schedule_cf_2','schedule_cf_3','schedule_cf_4','schedule_cf_5', 'audit_program_default_status_id', 'is_manual_entry', 'lead_auditor','second_auditor','worker_interviewer','ehs_auditor','asr','interpreter','observer'];
